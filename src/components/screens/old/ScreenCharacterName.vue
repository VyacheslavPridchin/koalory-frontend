<template>
  <section class="flex flex-col justify-center items-center min-h-screen px-6 py-16 bg-white" style="background-color: #F2F1EE">
    ...
    <div class="card max-w-md w-full relative">
      ...
      <p class="text-lg text-gray-700 text-center mb-6"  style="color: #C1C1C1;">What should we call them?</p>
      ...
      <button :disabled="!name" @click="handleContinue" class="w-full text-center bg-orange-500 hover:bg-orange-600 text-white font-bold py-4 rounded-lg text-lg shadow disabled:opacity-50">Continue</button>

<template>
  <section class="flex flex-col justify-center items-center min-h-screen px-6 py-4" style="background-color: #F2F1EE">
    ...
    <div class="flex-grow flex justify-center items-center">
      <div class="card max-w-lg w-full">
        ...
        <p class="text-lg text-center mb-6" style="color: #C1C1C1;">
          Upload a photo to see the magic happen instantly.
        </p>

        <!-- Drag & Drop Zone -->
        <div
            class="relative w-full flex flex-col items-center justify-center px-6 py-12 bg-orange-50 hover:bg-orange-60 rounded-2xl border-2 border-dashed border-orange-400 cursor-pointer transition hover:bg-yellow-50 hover:border-yellow-400 text-orange-500 font-bold text-lg mb-4 min-h-[220px]"
            @dragover.prevent
            @dragenter.prevent
            @drop.prevent="onDrop"
        ...
        <!-- Info Section -->
        <div class="bg-orange-50 rounded-lg p-4 text-sm text-gray-700 mb-6 text-center">
        ...
        <button
            ...
            class="w-full text-center bg-orange-500 hover:bg-orange-600 text-white font-bold py-4 rounded-lg text-lg shadow disabled:opacity-50"
        >
          ✨ Create My Hero
        </button>
